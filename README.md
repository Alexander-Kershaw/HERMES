...
This project demonstrates both batch and streamed data processing using Azure, Databricks, PySpark, Spark SQL, Delta Lake, and Kafka compatible streaming.
...
For HERMES I specifically wanted to apply data engineering principles in the contect of a retail business.

The underlying context of these works are as follows.

I am assuming the role of a data engineer working underneath a functional omnichannel retailer.
